...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("OMSysDataSet4"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class OMSysDataSet4
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As OMSysDataSet4 = CType(MyBase.Clone,OMSysDataSet4)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "OMSysDataSet4"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/OMSysDataSet4.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As OMSysDataSet4 = New OMSysDataSet4()
    ...
    Partial Public Class StockDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddStockRow(ByVal Product_type As String, ByVal Product_name As String, ByVal Product_price As Decimal, ByVal Quantity As Integer) As StockRow
            Dim rowStockRow As StockRow = CType(Me.NewRow,StockRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Product_type, Product_name, Product_price, Quantity}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByProduct_ID(ByVal Product_ID As Integer) As StockRow
            Return CType(Me.Rows.Find(New Object() {Product_ID}),StockRow)
        End Function
    ...
    Partial Public Class StockRow
        ...
        Public Property Product_ID() As Integer
            Get
                Return CType(Me(Me.tableStock.Product_IDColumn),Integer)
            End Get
            Set
                Me(Me.tableStock.Product_IDColumn) = value
            End Set
        End Property
        ...
        Public Property Product_type() As String
            Get
                Return CType(Me(Me.tableStock.Product_typeColumn),String)
            End Get
            Set
                Me(Me.tableStock.Product_typeColumn) = value
            End Set
        End Property
        ...
        Public Property Product_price() As Decimal
            Get
                Return CType(Me(Me.tableStock.Product_priceColumn),Decimal)
            End Get
            Set
                Me(Me.tableStock.Product_priceColumn) = value
            End Set
        End Property
...
Namespace OMSysDataSet4TableAdapters
    ...
    Partial Public Class StockTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Stock] WHERE (([Product_ID] = @Original_Product_ID) AND ([Prod"& _ 
                "uct_type] = @Original_Product_type) AND ([Product_name] = @Original_Product_name"& _ 
                ") AND ([Product_price] = @Original_Product_price) AND ((@IsNull_Quantity = 1 AND"& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Product_type", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Product_type", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Stock] ([Product_type], [Product_name], [Product_price], [Quan"& _ 
                "tity]) VALUES (@Product_type, @Product_name, @Product_price, @Quantity);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT"& _ 
                " Product_ID, Product_type, Product_name, Product_price, Quantity FROM Stock WHER"& _ 
                "E (Product_ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Stock] SET [Product_type] = @Product_type, [Product_name] = @Produc"& _ 
                "t_name, [Product_price] = @Product_price, [Quantity] = @Quantity WHERE (([Produc"& _ 
                "t_ID] = @Original_Product_ID) AND ([Product_type] = @Original_Product_type) AND "& _ 
                "([Product_name] = @Original_Product_name) AND ([Product_price] = @Original_Produ"& _ 
                "ct_price) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @O"& _ 
                "riginal_Quantity)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Product_ID, Product_type, Product_name, Product_pri"& _ 
                "ce, Quantity FROM Stock WHERE (Product_ID = @Product_ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Product_type", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Product_type", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Product_ID, Product_type, Product_name, Product_price, Quantity FROM dbo.S"& _ 
                "tock"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As OMSysDataSet4.StockDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As OMSysDataSet4.StockDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As OMSysDataSet4.StockDataTable = New OMSysDataSet4.StockDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As OMSysDataSet4.StockDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As OMSysDataSet4) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Product_ID As Integer, ByVal Original_Product_type As String, ByVal Original_Product_name As String, ByVal Original_Product_price As Decimal, ByVal Original_Quantity As Global.System.Nullable(Of Integer)) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(1).Value = CType(Original_Product_type,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Product_type As String, ByVal Product_name As String, ByVal Product_price As Decimal, ByVal Quantity As Global.System.Nullable(Of Integer)) As Integer
            If (Product_type Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Product_type")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(Product_type,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Product_type As String, ByVal Product_name As String, ByVal Product_price As Decimal, ByVal Quantity As Global.System.Nullable(Of Integer), ByVal Original_Product_ID As Integer, ByVal Original_Product_type As String, ByVal Original_Product_name As String, ByVal Original_Product_price As Decimal, ByVal Original_Quantity As Global.System.Nullable(Of Integer), ByVal Product_ID As Integer) As Integer
            If (Product_type Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Product_type")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(Product_type,String)
            End If
            If (Product_name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Product_name")
            Else
            ...
            If (Original_Product_type Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Product_type")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_Product_type,String)
            End If
            If (Original_Product_name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Product_name")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_Product_price,Decimal)
            If (Original_Quantity.HasValue = true) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Product_type As String, ByVal Product_name As String, ByVal Product_price As Decimal, ByVal Quantity As Global.System.Nullable(Of Integer), ByVal Original_Product_ID As Integer, ByVal Original_Product_type As String, ByVal Original_Product_name As String, ByVal Original_Product_price As Decimal, ByVal Original_Quantity As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Product_type, Product_name, Product_price, Quantity, Original_Product_ID, Original_Product_type, Original_Product_name, Original_Product_price, Original_Quantity, Original_Product_ID)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As OMSysDataSet4, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As OMSysDataSet4, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._stockTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As OMSysDataSet4, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._stockTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As OMSysDataSet4) As Integer
